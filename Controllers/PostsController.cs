...
using static FatihTuna.Startup;
...
namespace FatihTuna.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public PostsController(FatihTunaContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,Author,Date,Tags")] Post post)
        {
            if (id != post.Id)
            {
                return NotFound();
